...
A quick way to see Poetix's annotations is to run .summary() on a poem object.
...
More precisely, all of the statistics generated by Poetix are available in the dictionary .statd on the poem object.
